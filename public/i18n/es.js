(function(){window.__ihypeI18n=window.__ihypeI18n||{};window.__ihypeI18n['es']={
      ...
      'what.p2.desc':    'Cada entrada se divide directo: 70% al artista, 20% al local, 10% al promotor. iHYPE no se queda nada. El procesamiento de tarjeta y los impuestos se muestran como líneas separadas.',
      'what.p3.num':     '100%',
      ...
      'roles.artist.line':   'Publica canciones, planifica giras usando mapas de HYPE, cobra el 70% de cada entrada. Sin intermediarios.',
      ...
      'receipt.ex1.h':   'La división 70 / 20 / 10',
      'receipt.ex1.p':   '<strong>Artista 70%:</strong> hicieron la música. <strong>Local 20%:</strong> tienen la sala. <strong>Promotor 10%:</strong> trajeron al público. ¿Sin promotor? La división se reequilibra proporcionalmente.',
      ...
      'receipt.label.artist': 'Phantom Ridge · artista (70%)',
      'receipt.label.venue':  'State Theatre · local (20%)',
      ...
      'gov.rule2':       '<strong>Las reglas de pago no pueden cambiar</strong> sin votación de la junta. La división 70/20/10 está protegida.',
      ...
      // Ticketing page
      'tick.hero.eyebrow':    'Entradas · reparto 70/20/10 · sin comisión de plataforma',
      ...
      'prom.s2.lede':         'Una venta real de entrada de $45, desglosada. El artista hizo la música. El local tiene la sala. El promotor trajo al público. Se reparten 70/20/10. Nosotros no nos quedamos nada.',
      'prom.split.h':         'El reparto 70 / 20 / 10',
