(function(){window.__ihypeI18n=window.__ihypeI18n||{};window.__ihypeI18n['en']={
      ...
      'what.p2.num':     '70/20/10',
      'what.p2.title':   'Tickets pay the makers, not us.',
      'what.p2.desc':    'Every ticket splits direct: 70% to the artist, 20% to the venue, 10% to the promoter who brought the crowd. iHYPE takes nothing. Card processing and tax shown as separate line items.',
      'what.p3.num':     '100%',
      ...
      'roles.artist.line':     'Publish songs, plan tours using HYPE heatmaps, get paid 70% of every ticket. No middleman. No service fee. Tour planner built in.',
      ...
      'receipt.ex1.h':         'The 70 / 20 / 10 split',
      'receipt.ex1.p':         '<strong>Artist 70%:</strong> they made the music. <strong>Venue 20%:</strong> they hold the room and run the door. <strong>Promoter 10%:</strong> they brought the audience via their recommendation. No promoter attached? The split rebalances proportionally to artist and venue.',
      ...
      'receipt.label.artist':  'Phantom Ridge · artist (70%)',
      'receipt.label.venue':   'State Theatre · venue (20%)',
      ...
      'gov.rule2':       '<strong>Payout rules can\'t change</strong> without board vote. The 70/20/10 split is charter-protected.',
      ...
      // Ticketing page
      'tick.hero.eyebrow':    'Tickets · 70/20/10 split · zero platform fee',
      ...
      'prom.s2.lede':         'A real $45 ticket sale, itemized. The artist made the music. The venue holds the room. The promoter brought the crowd. They split 70/20/10. We take nothing.',
      'prom.split.h':         'The 70 / 20 / 10 split',
