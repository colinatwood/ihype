...
.booking-title { font-family: 'Syne', sans-serif; font-weight: 800; font-size: 34px; line-height: 1.0; letter-spacing: -0.03em; color: #f0ebe5; margin: 10px 0 10px; }
.booking-sub { font-family: 'DM Sans', sans-serif; font-size: 15px; line-height: 1.6; color: rgba(240,235,229,0.6); max-width: 56ch; margin: 0 0 24px; }
.booking-list { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 10px; }
.booking-card { display: flex; align-items: center; gap: 14px; padding: 14px 16px; background: #100d09; border: 1px solid rgba(255,255,255,0.06); border-radius: 16px; }
...
.booking-card-name { font-family: 'DM Sans', sans-serif; font-weight: 600; font-size: 16px; color: #f0ebe5; text-decoration: none; display: block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.booking-card-name:hover { color: #22e5d4; }
.booking-card-meta { font-family: 'DM Sans', sans-serif; font-size: 13px; color: rgba(240,235,229,0.5); margin-top: 2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
...
.booking-hype { font-family: 'JetBrains Mono', monospace; font-size: 9px; letter-spacing: 0.08em; text-transform: uppercase; color: rgba(240,235,229,0.55); background: rgba(255,255,255,0.04); border-radius: 4px; padding: 3px 7px; }
...
.booking-empty { text-align: center; padding: 32px; background: #100d09; border: 1px solid rgba(255,255,255,0.06); border-radius: 16px; }
.booking-empty p { font-family: 'DM Sans', sans-serif; color: rgba(240,235,229,0.6); margin: 0 0 14px; }
