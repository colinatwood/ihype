    ...
    <div style={{ maxWidth: 700, margin: '0 auto', padding: '32px 24px 100px' }}>
      ...
      {!isPending && data && !hasResults && (
        <div className="ihype-empty-state">
          <div className="icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg></div>
