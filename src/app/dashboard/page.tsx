...
const ArtistPageBuilder = dynamic(() => import('@/components/ArtistPageBuilder').then(m => ({ default: m.ArtistPageBuilder })), { ssr: false });
const PromoterPageBuilder = dynamic(() => import('@/components/PromoterPageBuilder').then(m => ({ default: m.PromoterPageBuilder })), { ssr: false });
const VenuePageBuilder = dynamic(() => import('@/components/VenuePageBuilder').then(m => ({ default: m.VenuePageBuilder })), { ssr: false });
