    ...
    <div className="adv-guard" style={{ display: 'grid', gridTemplateColumns: '.86fr 1.14fr', gap: 18, alignItems: 'start' }} ref={wrapperRef}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        {[
          ...
          { n: '04', title: 'Copyright firewall', desc: 'Ad copy is AI-screened, and your audio spot is transcribed and screened too, for protected song titles, lyrics, and artist name-drops you don\'t have rights to. Flagged for manual review on any match.' },
