...
export type View = 'me' | 'seeds' | 'radio' | 'studio' | 'tickets' | 'settings' | 'tour' | 'pagestudio' | 'artistpage' | 'venuepage' | 'notifications' | 'journal' | 'discover' | 'halflight' | 'matchmaker' | 'cockpit' | 'listen' | 'events' | 'pages' | 'leaderboard';
